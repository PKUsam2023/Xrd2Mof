...
class CSPDiffusion(BaseModule):
    ...
    def forward(self, batch):
        ...
        pred_l, pred_x = self.decoder(feature_embedding, time_emb, batch.atom_types, input_frac_coords, input_lattice, batch.num_atoms, batch.batch)
        ...
        # del pred_l, pred_x, tar_x, sigmas_per_atom, sigmas_norm_per_atom
        # torch.cuda.empty_cache()
    ...
    def sample(self, batch, step_lr = 1e-5):
        ...
        for t in tqdm(range(time_start, 0, -1)):
            ...
            pred_l, pred_x = self.decoder(feature_embedding, time_emb, batch.atom_types, x_t, l_t, batch.num_atoms, batch.batch)
            ...
            pred_l, pred_x = self.decoder(feature_embedding, time_emb, batch.atom_types, x_t_minus_05, l_t_minus_05, batch.num_atoms, batch.batch)
